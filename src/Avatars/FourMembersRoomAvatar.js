...
const FourMembersRoomAvatar = ({ size, members }) => {
  ...
  return (
    <View>
      ...
      <View style={styles.avatarLetterBox(0, size/2, size/2, size/2)}>
        <Text style={styles.avatarLetterText}>
          {getMemberLetter(members[2].name)}
        </Text>
      </View>

      <View style={styles.avatarLetterBox(size/2, size/2, size/2, size/2)}>
        <Text style={styles.avatarLetterText}>
